  ...
  if (variant === 'article') {
    return (
      <div className="my-8 bg-gradient-to-r from-canvas via-[#1a1a2e] to-canvas rounded-xl p-6 text-center border border-gray-800">
        <p className="text-gold font-display text-sm uppercase tracking-widest mb-1">From the ZuffaBets crew</p>
        ...
        <a
          href="https://fightbets.com"
          target="_blank"
          rel="noopener noreferrer"
          className="inline-block bg-octagon hover:bg-octagon-dark text-white px-6 py-2.5 rounded-full font-bold text-sm transition no-underline"
        >
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center gap-3 flex-wrap">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-octagon hover:bg-octagon-dark text-white px-4 py-1.5 rounded-full font-bold text-xs transition no-underline"
              >
                Bet on FightBets
              </a>
      ...
      <div className="relative z-10">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-3">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="bg-octagon hover:bg-octagon-dark text-white px-8 py-3 rounded-full font-bold text-sm transition no-underline"
          >
