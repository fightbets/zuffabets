        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="flex gap-3">
              <a href="https://twitter.com/zuffabets" target="_blank" rel="noopener noreferrer" className="bg-gray-800 hover:bg-tap text-white px-4 py-2 rounded-full text-xs font-bold transition">
                Twitter/X
              </a>
              <a href="https://instagram.com/zuffabets" target="_blank" rel="noopener noreferrer" className="bg-gray-800 hover:bg-octagon text-white px-4 py-2 rounded-full text-xs font-bold transition">
                Instagram
              </a>
            </div>
          </div>
